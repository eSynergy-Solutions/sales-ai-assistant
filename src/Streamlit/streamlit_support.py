...
def set_header(col1_title):
    with col1_title:
        st.image(
            "https://esynergy.co.uk/wp-content/themes/esynergy/images/eSynergy-Logo-1.png"
        )
    # with col2_title:
    #     st.title("CoPilot")
    ...
    with st.expander("User Information", expanded=True):
        ...
        st.markdown(
            "> Give me a summary of the Northern Trust Data Mesh    case study."
        )
        st.markdown(
            "> Create a proposal similar to Utmost with these    specific details."
        )
